...
::: notes
These six objectives cover foundational knowledge through clinical decision-making.
:::

------------------------------------------------------------------------

# Historical Overview {background-color="#27ae60"}
...
::: notes
Duggar's discovery launched an entire antibiotic class. The 2018 approvals represented a renaissance driven by resistance concerns.
:::
...
::: notes
Longer half-life agents allow for less frequent dosing and better compliance.
:::

------------------------------------------------------------------------

# Structure & Mechanism of Action {background-color="#8e44ad"}
...
![](images/tetracyclines.png){fig-align="center" width="1578"}
...
::: notes
The cation complex formation is essential for crossing gram-negative outer membranes - also explains why divalent cations interfere with absorption.
:::

## Ribosomal Binding & Protein Synthesis Inhibition {.smaller}
...
::::: columns
::: {.column width="50%"}
![](images/ribomse_target.png){fig-align="left"}
:::

::: {.column width="50%"}
**What happens at the ribosome**

1.  Tetracycline occupies the A (acceptor) site
2.  Blocks aminoacyl-tRNA binding
3.  Prevents peptide chain elongation → protein synthesis halts
...
::: notes
Reversible binding = bacteriostatic. This explains why post-antibiotic effect is important and why duration matters.
:::

------------------------------------------------------------------------

# Pharmacokinetics {background-color="#e74c3c"}
...
::: notes
This is a major practical advantage of doxycycline - patients with nausea can take it with meals.
:::
...
::: notes
One of the most important interactions to communicate. Many patients don't realize their daily vitamin interferes.
:::
...
::: notes
Higher lipophilicity = better tissue penetration. Minocycline's high lipophilicity explains its excellent CSF penetration.
:::

## Tissue Penetration {.smaller}
...
::: notes
Tissue penetration drives clinical indications. Minocycline's CNS penetration makes it useful for certain infections. Tetracyclines have high volume of distribution making them poor choices for bloodstream infection
:::
...
::: notes
This is a frequently tested point - doxycycline's unique elimination makes it safe in renal impairment.
:::

------------------------------------------------------------------------

# Antimicrobial Spectrum {background-color="#3498db"}
...
::: notes
MRSA susceptibility to doxycycline makes it useful for community skin infections. However, resistance is increasing.
:::

## Gram-Negative Coverage{.smaller}
...
::: notes
The gram-negative spectrum focuses on atypicals and specific pathogens. Not reliable for nosocomial gram-negatives.
:::
...
::: notes
Doxycycline is often the drug of choice for tick-borne illnesses due to excellent activity against Rickettsia and related organisms.
:::
...
::: notes
Doxycycline's activity against T. pallidum makes it the alternative of choice for penicillin-allergic patients with syphilis.
:::

------------------------------------------------------------------------

# Clinical Indications {background-color="#f39c12"}
...
::: notes
With rising macrolide resistance in S. pneumoniae, doxycycline has become an increasingly important alternative.
:::
...
::: notes
Empiric treatment of suspected RMSF can be lifesaving. Doxycycline is safe even in children for this indication.
:::
...
::: notes
Doxy-PEP is a major recent development - single dose within 72 hours of exposure significantly reduces gonorrhea, chlamydia, and syphilis.
:::
...
::: notes
Sub-antimicrobial doxycycline (40 mg) is effective for acne through anti-inflammatory mechanisms without promoting resistance.
:::

## Infections Requiring Combination Therapy {.smaller}
...
::: notes
For brucellosis, the combination prevents relapse. Q fever endocarditis requires prolonged therapy.
:::
...
::: notes
Demeclocycline's use for SIADH is a classic example of repurposing a side effect for therapeutic benefit.
:::
...
::: notes
Esophageal ulceration can be severe. The upright position and water are critical counseling points.
:::
...
::: notes
Photosensitivity is a phototoxic (not allergic) reaction. It can occur even through window glass with UVA.
:::
...
::: notes
The age 8 cutoff is when permanent teeth are largely formed. Doxycycline may have lower staining risk than older tetracyclines.
:::
...
::: notes
Minocycline's vestibular effects often limit its use. The combination with isotretinoin is particularly concerning for intracranial hypertension.
:::
...
::: notes
High-dose IV tetracycline is no longer used, but this historical toxicity is why the class carries pregnancy warnings.
:::
...
::: notes
The pigmentation can be disfiguring and may not fully resolve. Monitor for lupus-like symptoms in long-term users.
:::

------------------------------------------------------------------------

# Drug Interactions {background-color="#1abc9c"}
...
::: notes
The warfarin interaction is clinically significant - always check INR when starting/stopping tetracyclines in anticoagulated patients.
:::
...
# Resistance Mechanisms {background-color="#e67e22"}
...
# Newer Tetracycline Derivatives {background-color="#16a085"}
...
# Chloramphenicol {background-color="#c0392b"}
...
# Practical Prescribing {background-color="#2980b9"}
...
# Appendix: Reference Tables {background-color="#7f8c8d"}
