...
![](tetracyclines-images/resistance_MOA.png){fig-align="center" width="650"}

<br>

::: aside
33+ resistance genes identified, often carried on mobile genetic elements. Multiple mechanisms may coexist. Efflux is the most common mechanism. Ribosomal protection is especially important in gram-positive organisms. Tet(X) enzymes are concerning because they can inactivate even the newer glycylcyclines. Surveillance is ongoing [@Chopra2001; @Roberts2005; @Thaker2010].
:::
...
::: aside
The mortality signal led to FDA warnings. Tigecycline should not be used for VAP or bacteremia due to low serum levels. Mortality difference was not seen with the higher dose [@Ellis-GrosseTige2005; @FDABoxWarningTige2013].
:::
